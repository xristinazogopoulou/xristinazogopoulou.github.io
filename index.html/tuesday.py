...
def filter_odd(xs):
    ...
    Anytime you feel tempted to delete something from the list,
    you will use this accumulator pattern.
    Instead of deleteting from the input list, 
    I'm going to create a new empty list, then append the things I'm 'not deleting.' 
    >>> filter_odd([2,4,6])
    [2, 4, 6]
    >>> filter_odd([1,3,5])
    []
