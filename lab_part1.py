...
import json
paths = ['condensed_2009.json', 'condensed_2010.json', 'condensed_2011.json', 'condensed_2012.json', 'condensed_2013.json','condensed_2014.json','condensed_2015.json', 'condensed_2016.json', 'condensed_2017.json', 'condensed_2018.json']
tweets = []
for path in paths:
...
list=['obama', 'trump', 'mexico', 'russia', 'fake news', 'women', 'greece', 'democrats']
for word in list:
    num_word=0
    for tweet in tweets:
...
for word in list:
    ...
    for tweet in tweets:
        if word in tweet['text'].lower():
            num_word+=1
    percentage=round(num_word/num_tweets*100,2)    
